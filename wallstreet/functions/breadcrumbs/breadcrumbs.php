...
$wallstreet_breadcrumb_type = get_theme_mod('wallstreet_breadcrumb_type','default');
if($wallstreet_breadcrumb_type == 'yoast') {
...
elseif($wallstreet_breadcrumb_type == 'navxt'){
...
elseif($wallstreet_breadcrumb_type == 'rankmath') {
if( function_exists( 'rank_math_the_breadcrumbs' ) )
{
rank_math_the_breadcrumbs();
} 
}
elseif($wallstreet_breadcrumb_type == 'default') {
