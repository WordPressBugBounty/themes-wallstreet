...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Wallstreet_Slider_Custom_Control extends Wallstreet_Range_Slider_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_script( 'wallstreet-custom-controls-js', $this->get_wallstreet_resource_url() . 'inc/customizer/customizer-slider/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'wallstreet-custom-controls-css', $this->get_wallstreet_resource_url() . 'inc/customizer/customizer-slider/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
