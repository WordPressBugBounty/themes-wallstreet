			...
			if($wallstreet_current_options['social_media_twitter_link'] !='' || $wallstreet_current_options['social_media_facebook_link'] !='' || $wallstreet_current_options['social_media_linkedin_link'] !='' || $wallstreet_current_options['social_media_youtube_link'] !='' || $wallstreet_current_options['social_media_instagram_link'] !='' ) { ?>
				<div class="footer-social-area">
					<ul class="footer-social-icons">
						...
						<li><a href="<?php echo esc_url( $wallstreet_current_options['social_media_twitter_link']); ?>"><i class="fa-brands fa-x-twitter"></i></a></li>
						<?php }
						if($wallstreet_current_options['social_media_facebook_link']!='') { ?>
						<li><a href="<?php echo esc_url( $wallstreet_current_options['social_media_facebook_link']); ?>"><i class="fa-brands fa-facebook-f"></i></a></li>
						<?php }					
						if($wallstreet_current_options['social_media_linkedin_link']!='') { ?>
						<li><a href="<?php echo esc_url( $wallstreet_current_options['social_media_linkedin_link']); ?>"><i class="fa-brands fa-linkedin-in"></i></a></li>
						<?php }
						if($wallstreet_current_options['social_media_youtube_link']!='') { ?>
						<li><a href="<?php echo esc_url( $wallstreet_current_options['social_media_youtube_link']); ?>"><i class="fa-brands fa-youtube"></i></a></li>					
						<?php } if($wallstreet_current_options['social_media_instagram_link']!='') { ?>
						<li><a href="<?php echo esc_url( $wallstreet_current_options['social_media_instagram_link'] ); ?>"><i class="fa-brands fa-instagram"></i></a></li>					
						<?php } ?>
					</ul>
				</div>
				<?php }
