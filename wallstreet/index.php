...
<?php
if((get_post_meta(get_option('page_for_posts', true),'wallstreet_site_layout', true )=='wallstreet_site_layout_stretched') || (get_theme_mod('blog_sidebar_layout','right')=='stretched')) {
...
<div class="container theme-index <?php echo esc_attr($wallstreet_page_class);?>" id="content">
	<div class="row">
		<?php
		if(get_post_meta(get_option('page_for_posts', true),'wallstreet_site_layout', true )=='')
            {
            ...
            else if(get_post_meta(get_option('page_for_posts', true),'wallstreet_site_layout', true ) == 'wallstreet_site_layout_left') 
            {
                echo '<div class="col-lg-4 col-md-4 col-sm-12"><div class="sidebar left-sidebar">';
                    dynamic_sidebar($wallstreet_page_sidebar); 
                echo '</div></div>';
                echo '<div class="col-lg-8 col-md-8 col-sm-12">';
            }
            else if(get_post_meta(get_option('page_for_posts', true),'wallstreet_site_layout', true ) == 'wallstreet_site_layout_right')
            {
                echo '<div class="col-lg-8 col-md-8 col-sm-12">';
            }
            else if(get_post_meta(get_option('page_for_posts', true),'wallstreet_site_layout', true ) == 'wallstreet_site_layout_without_sidebar')
            {
                echo '<div class="col-lg-12 col-md-12 col-sm-12">'; 
            }
            else
		...
		<?php
		 if(((get_theme_mod('blog_sidebar_layout','right')=='right') && get_post_meta(get_option('page_for_posts', true),'wallstreet_site_layout', true )=='') || get_post_meta(get_option('page_for_posts', true),'wallstreet_site_layout', true )=='wallstreet_site_layout_right'):
                echo '<div class="col-lg-4 col-md-4 col-sm-12"><div class="sidebar-section">';
                   dynamic_sidebar($wallstreet_page_sidebar); 
                echo '</div></div>';
        endif;?>
